...
#def precompute_frequencies(dim, max_pos, theta=10000.0):
#    """Compute frequencies for a given range and interleave sine and cosine to match `dim`."""
#    inv_freq = 1.0 / (theta ** (jnp.arange(0, dim, 2, dtype=jnp.float32) / dim))
#    t = jnp.arange(0, max_pos, dtype=jnp.float32)
#    freqs = jnp.outer(t, inv_freq)
    
    # Interleave cos and sin frequencies to match the full `dim` (head dimension)
